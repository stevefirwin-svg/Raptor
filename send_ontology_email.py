...
<div style="max-width:800px;margin:0 auto;background:#12122a;border:1px solid #2a2a3e">
  ...
  <div style="background:linear-gradient(135deg,#1a1a3e,#0d0d2b);padding:24px 28px;border-bottom:2px solid #00d4aa">
    <div style="color:#00d4aa;font-size:13px;letter-spacing:3px;text-transform:uppercase;font-weight:700">RAPTOR v5.5</div>
  ...
  <div style="padding:16px 28px;border-bottom:1px solid #2a2a3e">
    ...
    <table style="width:100%;border-collapse:collapse;font-size:12px">
      ...
      <tr style="background:#1a1a2e">
        ...
        <td style="padding:6px 10px;color:#a0a0b0">universe_builder → signals.py → MOMENTUM + MEAN_REVERSION books, BottomTopDetector, CompositeRanker</td>
      </tr>
      <tr>
        ...
        <td style="padding:6px 10px;color:#a0a0b0">main.py → EntryAgent → BUY orders → ledger (trade_type: MOM|MR) → per-book logs</td>
      </tr>
      <tr style="background:#1a1a2e">
        ...
        <td style="padding:6px 10px;color:#a0a0b0">exit_monitor → trade_type-aware exits (MOM: wide trail | MR: tight trail + 5d cap) + math trim</td>
      </tr>
      <tr>
  ...
  <div style="padding:16px 28px;text-align:center">
    <div style="color:#3a3a5e;font-size:11px">RAPTOR v5.5 | llama3.2 Agent Layer | Math-First Architecture</div>
...
msg["Subject"] = f"RAPTOR v5.5 — System Architecture Ontology ({datetime.now().strftime('%Y-%m-%d')})"
